...
button_rock = tkinter.Button(root, text="Stone", command=rock)
button_rock.pack()
...
label_annouce = tkinter.Label(root, text="Computer Chose")
label_annouce.pack()

label_user_choice = tkinter.Label(root, justify=tkinter.LEFT, font="Courier", text="")
label_user_choice.pack()
label_annouce2 = tkinter.Label(root, text="You Chose")
label_annouce2.pack()
